function chamarGraficoTI() {
  ...
  gerarGrafico(
    'grafico1',
    'ÉTICA E USO POLÍTICO DAS TIC',
      'SOCIEDADE DA INFORMAÇÃO E IMPACTOS',
      'RELAÇÃO ENTRE INTERNET E CONSUMO',
      'IMPACTO SOCIOCULTURAL DAS TIC',
      'ACESSO A TECNOLOGIAS E TIC NO TRABALHO',
      'TECNOLOGIA DA INFORMAÇÃO 3° A ',
    mediageral1_qui,
    mediageral2_qui,
    mediageral3_qui,
    mediageral4_qui,
